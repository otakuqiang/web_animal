 ...
 */
@WebServlet("/selectscienceview")
public class SelectScienceView extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		web_animal_science s = null;
		
		if (id!=null) {
		
			s = web_animal_scienceDao.selectByID(Integer.parseInt(id));
		
		
			request.setAttribute("s", s);
		}
		   
		request.getRequestDispatcher("scienceview.jsp").forward(request, response);
