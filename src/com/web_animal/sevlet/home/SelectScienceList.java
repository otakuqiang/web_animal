 ...
 */
@WebServlet("/selectsciencelist")
public class SelectScienceList extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		ArrayList<web_animal_science> slist = null;

		slist = web_animal_scienceDao.selectAll();

		request.setAttribute("slist", slist);

		request.getRequestDispatcher("sciencelist.jsp").forward(request, response);
